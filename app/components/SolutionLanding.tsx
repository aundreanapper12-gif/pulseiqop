        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.08fr_.92fr] lg:items-center">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              <a href="/pricing" className="inline-flex items-center justify-center gap-2 rounded-full border border-black/15 bg-white/75 px-7 py-4 font-black">Explore Analysis Options</a>
            </div>
          </div>

          <aside className="rounded-[2.2rem] border border-black/10 bg-[#111] p-7 text-white shadow-2xl md:p-9">
            <div className="flex items-center gap-3"><Search size={20} /><p className="text-xs font-black uppercase tracking-[0.2em] text-white/40">Executive Diagnostic Focus</p></div>
      ...
      <section className="px-5 py-24 md:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-4xl">
            <p className="text-xs font-black uppercase tracking-[0.22em] text-black/38">The PulseIQ Approach</p>
            <h2 className="mt-3 text-4xl font-black tracking-tight md:text-6xl">Move From A Concerning Number To A Decision-Ready Business Question.</h2>
          </div>
      ...
      <section className="bg-[#111] px-5 py-24 text-white md:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-7 text-xs font-black uppercase tracking-[0.22em] text-white/40">Decision-Grade Analysis</p>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-7 md:p-9">
            ...
            <div className="mt-7 flex flex-wrap gap-3 text-sm font-black text-white/70"><span className="rounded-full border border-white/10 px-4 py-2">Direct Variances</span><span className="rounded-full border border-white/10 px-4 py-2">Modeled Opportunities</span><span className="rounded-full border border-white/10 px-4 py-2">Data Quality Signals</span><span className="rounded-full border border-white/10 px-4 py-2">Executive Priorities</span></div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl rounded-[2.4rem] border border-black/10 bg-white/80 p-8 shadow-xl md:p-12">
          <div className="grid gap-8 lg:grid-cols-[1fr_.72fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-black tracking-tight md:text-5xl">Executive-Level Insight Without The Cost Of An In-House Analytics Team.</h2>
              <p className="mt-5 max-w-3xl text-lg leading-8 text-black/55">Start with the free PulseIQ workspace. When a signal deserves deeper investigation, move into a focused or full analysis built around transparent assumptions, meaningful evidence, and practical next steps.</p>
            </div>
